...
@Component
@Slf4j
public class RawTrackInfoSqltDao {
    private static final String SQL_INSERT_TRACK_INFO =
            "INSERT INTO R_MUS_INFO(ARTIST, ALBUM, TRACK, SOURCE_ID, DATE_CREATE, TAGS) VALUES (?,?,?,?,?,?)";
